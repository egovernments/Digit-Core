...
<#-- Same as base login.ftl, but the "Don't have an account? Register" block is removed
     (displayInfo=false and no "info" section). Assign this theme to a client to hide
     self-registration for that client only. -->
