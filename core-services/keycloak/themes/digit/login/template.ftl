...
<div class="kc-shell">
    ...
    <header class="kc-brandbar">
        <div class="kc-brandbar__inner">
            <div class="kc-brand">
                <img class="kc-brand__logo" src="${url.resourcesPath}/img/logo.png" alt="City of Cape Town logo"/>
                <span class="kc-brand__name">City of Cape Town &mdash; Admin Console</span>
            </div>
