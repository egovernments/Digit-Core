package org.egov.payment.repository;
...
class TransactionQueryBuilder {
    ...
    private static String addPagination(String query, TransactionCriteria transactionCriteria, List<Object> preparedStmtList) {
