...
/**
 * Search and get program(s) based on search criteria
 */
@Schema(description = "Search and get program(s) based on search criteria")
@Validated
...
public class ProgramSearchRequest {
	...
	@Valid
	private ProgramSearch criteria = null;
