...
/**
 * Search and get estimate(s) based on search criteria
 */
@Schema(description = "Search and get estimate(s) based on search criteria")
@Validated
...
public class EstimateSearchRequest {
	...
	@Valid
	private EstimateSearch criteria = null;
