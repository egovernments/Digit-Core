...
/**
 * Search and get sanction(s) based on search criteria
 */
@Schema(description = "Search and get sanction(s) based on search criteria")
@Validated
...
public class SanctionSearchRequest {
	...
	@Valid
	private SanctionSearch criteria = null;
