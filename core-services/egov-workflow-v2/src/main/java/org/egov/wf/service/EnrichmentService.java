...
public class EnrichmentService {
	...
	@Autowired
	public EnrichmentService(WorkflowUtil util, UserAdapter userAdapter, TransitionService transitionService) {
		this.util = util;
	...
	public void enrichUsers(RequestInfo requestInfo, List<ProcessStateAndAction> processStateAndActions) {
		...
		Map<String, User> idToUserMap = userAdapter.searchUser(requestInfo, uuids);
	...
	public Set<String> enrichUuidsOfAutoEscalationEmployees(RequestInfo requestInfo, ProcessInstanceSearchCriteria criteria) {
		...
		List<String> uuidsOfAutoEscalationEmployees = userAdapter.searchUserUuidsBasedOnRoleCodes(userSearchRequest);
