...
public class ActionQueryBuilder {
	...
	public static String insertActionQuery() {
		...
		return "INSERT INTO eg_action(id,name,url,servicecode,queryparams,parentmodule,ordernumber,displayname,enabled,createdby,lastmodifiedby,createddate,lastmodifieddate,method,resource,condition) values "
				+ "(nextval('seq_eg_action'),:name,:url,:servicecode,:queryparams,:parentmodule,:ordernumber,:displayname,:enabled,:createdby,:lastmodifiedby,:createddate,:lastmodifieddate,:method,:resource,:condition)";
	}

	public static String updateActionQuery() {
		logger.info("ActionQueryBuilder : updateActionQuery");
		return "update eg_action set url=:url,servicecode=:servicecode, queryparams=:queryparams, parentmodule=:parentmodule,ordernumber=:ordernumber,displayname=:displayname,enabled=:enabled,lastmodifiedby=:lastmodifiedby,lastmodifieddate=:lastmodifieddate,method=:method,resource=:resource,condition=:condition where name=:name";
	}
