...
public class RoleActionResponse   {
        ...
        @JsonProperty("roleActions")
          @Valid
                private List<RoleAction> roleActions = null;


        public RoleActionResponse addRoleActionsItem(RoleAction roleActionsItem) {
            if (this.roleActions == null) {
            this.roleActions = new ArrayList<>();
            }
        this.roleActions.add(roleActionsItem);
        return this;
        }
