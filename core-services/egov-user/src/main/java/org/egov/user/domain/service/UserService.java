...
public class UserService {
    ...
    public List<org.egov.user.domain.model.User> searchUsers(UserSearchCriteria searchCriteria,
        ...
        List<String> encryptedUserNames = encryptStringListAsUserField(
                searchCriteria.getUserNames(), UserField.USERNAME);
        List<String> encryptedMobileNumbers = encryptStringListAsUserField(
                searchCriteria.getMobileNumbers(), UserField.MOBILE_NUMBER);
...
//    }
    ...
    private List<String> encryptStringListAsUserField(List<String> values, UserField field) {
        ...
        List<User> encrypted = (List<User>) encryptionDecryptionUtil
                .encryptObject(wrappers, "User", User.class);
