...
public class SubTenantApiControllerTest {
    ...
    @Test
    public void subTenantSearchGetSuccess() throws Exception {
    ...
    @Test
    public void subTenantSearchGetFailure() throws Exception {
        mockMvc.perform(post("/api/subTenant/_search").contentType(MediaType
        .APPLICATION_JSON_UTF8))
        .andExpect(status().isBadRequest());
    }
    ...
    @Test
    public void subTenantUpdatePutSuccess() throws Exception {
    ...
    @Test
    public void subTenantUpdatePutFailure() throws Exception {
        mockMvc.perform(post("/api/subTenant/_update").contentType(MediaType
        .APPLICATION_JSON_UTF8))
        .andExpect(status().isBadRequest());
    }
