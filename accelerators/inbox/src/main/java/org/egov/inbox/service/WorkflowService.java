...
public class WorkflowService {
	...
	public List<HashMap<String, Object>> getProcessStatusCount(RequestInfo requestInfo,
		...
		for (String businessSrv : listOfBusinessServices) {
			...
			if ((!ObjectUtils.isEmpty(criteria.getModuleName())
					&& !criteria.getModuleName().equalsIgnoreCase(BpaConstants.BPA))
			...
			if (criteria != null && !ObjectUtils.isEmpty(criteria.getModuleName())
				...
				if (finalResponse == null) {
					...
					finalResponse.addAll(
							(List<HashMap<String, Object>>) serviceRequestRepository.fetchListResult(url,
									requestInfoWrapper));
				}
			}
		}
	...
	public Map<String, String> getStatusIdToStateMap(List<BusinessService> businessServices) {

		Map<String, String> statusIdToStateMap = new HashMap<>();
