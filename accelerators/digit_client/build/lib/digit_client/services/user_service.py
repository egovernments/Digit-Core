...
class UserService:
    ...
    def create_citizen(self, citizen_user: CitizenUser, request_info: Optional[RequestInfo] = None, temp_auth_token: Optional[str] = None) -> Dict:
        """
    ...
    def get_user_details(self, tenant_id: str, request_info: Optional[RequestInfo] = None, temp_auth_token: Optional[str] = None) -> Dict:
        """
    ...
    def update_profile(self, user_profile: UserProfileUpdate, request_info: Optional[RequestInfo] = None, temp_auth_token: Optional[str] = None) -> Dict:
        """
        Update user profile.
    ...
    def search_users(self, search_criteria: UserSearchModel, request_info: Optional[RequestInfo] = None, temp_auth_token: Optional[str] = None) -> Dict:
        """
    ...
    def create_user_no_validate(self, citizen_user: CitizenUser, request_info: Optional[RequestInfo] = None, temp_auth_token: Optional[str] = None) -> Dict:
        """
    ...
    def update_user_no_validate(self, user_profile: UserProfileUpdate, request_info: Optional[RequestInfo] = None, temp_auth_token: Optional[str] = None) -> Dict:
        """
