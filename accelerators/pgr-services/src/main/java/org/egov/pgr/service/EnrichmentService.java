...
public class EnrichmentService {
	...
	@Autowired
	public EnrichmentService(PGRUtils utils, IdGenRepository idGenRepository, PGRConfiguration config, UserService userService, IndividualService individualService) {
		this.utils = utils;
	...
	public void enrichCreateRequest(ServiceRequest serviceRequest) {
		...
		if (config.getIsIndividualIntegrationEnabled()) {
			individualService.callIndividualService(serviceRequest);
		}
	...
	public void enrichSearchRequest(RequestInfo requestInfo, RequestSearchCriteria criteria) {
		...
		if (criteria.getMobileNumber() != null) {
			...
			if (config.getIsIndividualIntegrationEnabled()) {
				individualService.enrichUserIds(tenantId, criteria, requestInfo);
			}
		}
