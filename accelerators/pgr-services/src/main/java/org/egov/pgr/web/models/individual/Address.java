 ...
 */
@ApiModel(
		description = "Representation of a address. Individual APIs may choose to extend from this using allOf if more details needed to be added in their case. "
)
@Validated
...
public class Address {
	...
	private @Valid org.egov.pgr.web.models.individual.Boundary locality = null;
	@JsonProperty("ward")
