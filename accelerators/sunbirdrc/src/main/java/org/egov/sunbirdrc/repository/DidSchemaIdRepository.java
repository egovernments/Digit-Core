...
public class DidSchemaIdRepository {
    ...
    private static final String sql = "SELECT uuid, did, schemaid FROM uuid_did_schemaid_mapper";
    ...
    public void loadData() {
        try {
            ...
            String sampleValue = (String) stringRedisTemplate.opsForHash().get("uuid_did_schemaid_mapper","0ca132eb-d1e4-4232-a195-a535fd1795ed");
    ...
    private String convertObjectToJson(Object object) {
        ...
        try {
            ...
            log.error("failed to deserialize the object", e);// Handle the exception properly
            return null;
        }
    }
}
