...
export const TorchNoun = ({ className, style = {}, height = "20", width = "25", fill = "#F47738" }) => {
  return (
    <svg width={width} height={height} className={className} style={style} viewBox="0 0 20 25" fill="none" xmlns="http://www.w3.org/2000/svg">
